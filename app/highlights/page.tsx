          ...
          >
            ...
            <div className="relative w-full h-full flex items-center justify-center bg-black">
              ...
              <div className="absolute right-4 sm:right-6 bottom-24 sm:bottom-32 flex flex-col gap-6 z-10">
                ...
                {/* Share Button */}
                <button className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center hover:bg-white/30 transition-all">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
